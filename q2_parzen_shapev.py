...
results_parzen_shapev = np.zeros((300, 1))
...
for n in range(30):
    ...
    for o in range(10):
        ...
        print("A acurácia da iteração", n+o+1, "foi de:", result_parzen_shapev)

        for i in range(n, n + 1):
            for j in range(1):
                results_parzen_shapev[i, j] = result_parzen_shapev

        np.savetxt("q2_parzen_shapev.txt", results_parzen_shapev, fmt="%.6f")